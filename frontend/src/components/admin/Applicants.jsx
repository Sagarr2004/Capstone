    ...
    return (
        <div>
            ...
            <div className="max-w-7xl mt-8 mx-auto px-6">
                <h1 className="font-bold text-2xl text-gray-800 mb-4">Applicants ({applicants?.applications?.length || 0})</h1>
                {loading && <p className="text-blue-500 text-lg animate-pulse">Processing resumes...</p>}
                
                {/* Downloaded Resumes Section */}
                {resumeLinks.length > 0 && (
                    <div className="mt-6 p-6 border rounded-lg shadow-lg bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100">
